...
export function Catalogue() {
  ...
  return <main className="catalogue-page" id="main-content">
    ...
    <footer className="catalogue-footer"><p>Want to be considered for the catalogue?</p><Link className="button button-dark" href="/signup">Create your profile <ArrowRight size={16} /></Link></footer>
