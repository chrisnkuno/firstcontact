    ...
    <main id="main-content">
      ...
      <section className="system-section section-shell">
        ...
        <div className="system-bento">
          <article className="bento-discover"><span>01 / DISCOVER</span><h3><T>Search the public record.</T></h3><p><T>Exa maps firms, people, mandates, portfolios, and current thesis evidence across four capital regions.</T></p><div className="mini-flow"><i>PROFILE</i><b>→</b><i>SOURCES</i><b>→</b><i>SHORTLIST</i></div></article>
      ...
      <footer className="footer section-shell"><div><strong>FIRSTCONTACT</strong><p><T>Open infrastructure for capital access.</T><br /><T>Built with care, from everywhere.</T></p></div><div><span>PRODUCT</span><Link href="/workspace"><T>Founder workspace</T></Link><Link href="/catalogue"><T>VC catalogue</T></Link><Link href="/signup"><T>Join FirstContact</T></Link></div><div><span>PROJECT + POLICIES</span><a href="https://github.com/chrisnkuno/firstcontact" target="_blank" rel="noreferrer">GitHub ↗</a><Link href="/responsible-outreach"><T>Responsible outreach</T></Link><Link href="/privacy"><T>Privacy</T></Link><Link href="/terms"><T>Terms</T></Link><Link href="/security"><T>Security</T></Link></div><p className="license">MIT · FirstContact contributors</p></footer>
    </main>
  );
}
